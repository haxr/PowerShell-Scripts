...
[xml]$docDevInfo = (New-Object System.Net.WebClient).DownloadString("http://$phoneIP$urlDevInfo")

If ($docDevInfo.DeviceInformation.phoneDN) {

[xml]$docDevNetConfig = (New-Object System.Net.WebClient).DownloadString("http://$phoneIP$urlDevNetConfig")
